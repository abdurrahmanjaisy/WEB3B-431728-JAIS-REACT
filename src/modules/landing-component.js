                            ...
                            <Row>
                                <Col span={24}>
                                    <div className="title-container">
                                        <span className="text-soft-blue title-biggest bold">Welcome!</span>
                                        <br/>
                                        <span className="text-soft-blue title-big bold">Abdurrahman Jaisy</span>
                                    </div>
                                </Col>
                                <Col span={24}>
                                ...
                                <Col span={24}>
                                    ...
                                    <a href="mailto:abdurrahmanjaisy@mail.ugm.ac.id?Subject=Halo%20Jais">                              
                                        <ButtonHome
                                            text="Text Me"
                                ...
                                <Modal
                                    ...
                                    >
                                    <p className="text-notif">Pebisnis - Business Inquiries abdurrahmanjaisy@mail.ugm.ac.id</p>
